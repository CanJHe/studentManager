        ...
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" id="sub">
                <div class="form-group">
                    <label for="teach_number" class="col-sm-2 control-label">教师代号</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="teach_number" name="teach_number" placeholder="请输入教师代号">
                    </div>
                </div>
                <div class="form-group">
                    <label for="teach_name" class="col-sm-2 control-label">姓名</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="teach_name" name="teach_name" placeholder="请输入教师姓名">
                    </div>
                </div>
                ...
                <%--<div class="form-group">--%>
                    <%--<label for="stu_addr" class="col-sm-2 control-label">称号</label>--%>
                    <%--<div class="col-sm-10">--%>
                        <%--<input type="text" class="form-control" id="stu_addr" name="stu_addr" value="${student.stu_addr}" placeholder="请输入教师称号">--%>
                    <%--</div>--%>
                <%--</div>--%>
                <div class="form-group">
                    <label class="col-sm-2 control-label">教师称号</label>
                    <div class="col-sm-10">
                        <input list="nickname" name="nickname" class="form-control" placeholder="请输入教师称号"/>
