...
<div class="container">
    ...
    <div class="row" style="margin-top: 3%">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/addCourse">
                ...
                <div class="form-group">
                    <label for="teach_time" class="col-sm-2 control-label">开课时间</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="teach_time" name="teach_time" placeholder="请输入学生开课时间(yyyy-MM-dd)">
                    </div>
                </div>
                <div class="form-group">
                    <label for="teacher" class="col-sm-2 control-label">授课教师</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="teacher" id="teacher" placeholder="请输入课程授课教师">
                    </div>
                </div>
                <div class="form-group">
